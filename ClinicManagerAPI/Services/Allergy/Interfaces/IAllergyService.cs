...
namespace ClinicManagerAPI.Services.Allergy.Interfaces
{
    ...
    public interface IAllergyService
    {
        ...
        Task<AllergyDto> CreateAllergy(CreateAllergyDto createAllergyDto);
        ...
        Task<OperationResult> DeleteAllergy(int id);
        ...
        Task<PagedResult<AllergyDto>> GetAllergies(AllergyQueryParameters parameters);
        ...
        Task<AllergyDto> UpdateAllergy(int id, UpdateAllergyDto updateAllergyDto);
    }
}